...
function App() {
  ...
  const generateVideo = async () => {
    ...
    setGenerationError('')
    try {
      const videoUrl = await createVideo({ prompt, aspectRatio: aspect, duration, quality, style, contentType, voice, music, language })
